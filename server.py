...
CATALOG_DEFAULTS.extend(
    [
        {"key": "piercing-lobulo", "segment": "piercing", "category": "Orelha", "name": "Lóbulo", "price_cents": 5000, "duration_minutes": 45, "description": "Perfuração clássica no lóbulo, com posicionamento definido em avaliação.", "image": "/assets/servicos/piercing/lobulo.jpg", "icon": "◉"},
        {"key": "piercing-upper-lobe", "segment": "piercing", "category": "Orelha", "name": "Upper Lobe", "price_cents": 5000, "duration_minutes": 45, "description": "Perfuração na parte superior do lóbulo para composições e projetos de orelha.", "image": "/assets/servicos/piercing/upper-lobe.jpg", "icon": "◉"},
        {"key": "piercing-helix", "segment": "piercing", "category": "Orelha", "name": "Helix", "price_cents": 5000, "duration_minutes": 45, "description": "Perfuração na borda externa da cartilagem da orelha, sujeita à avaliação de anatomia.", "image": "/assets/servicos/piercing/helix.jpg", "icon": "◇"},
        {"key": "piercing-forward-helix", "segment": "piercing", "category": "Orelha", "name": "Forward Helix", "price_cents": 5000, "duration_minutes": 45, "description": "Perfuração na cartilagem frontal superior da orelha, conforme anatomia individual.", "image": "/assets/servicos/piercing/forward-helix.jpg", "icon": "◇"},
        {"key": "piercing-flat", "segment": "piercing", "category": "Orelha", "name": "Flat", "price_cents": 5000, "duration_minutes": 45, "description": "Perfuração na área plana da cartilagem superior da orelha.", "image": "/assets/servicos/piercing/flat.jpg", "icon": "◇"},
        {"key": "piercing-tragus", "segment": "piercing", "category": "Orelha", "name": "Tragus", "price_cents": 5000, "duration_minutes": 45, "description": "Perfuração na pequena cartilagem diante do canal auditivo, após avaliação.", "image": "/assets/servicos/piercing/tragus.jpg", "icon": "◇"},
        {"key": "piercing-antitragus", "segment": "piercing", "category": "Orelha", "name": "Anti-tragus", "price_cents": 5000, "duration_minutes": 45, "description": "Perfuração na cartilagem oposta ao tragus, dependente da anatomia.", "image": "/assets/servicos/piercing/anti-tragus.jpg", "icon": "◇"},
        {"key": "piercing-conch", "segment": "piercing", "category": "Orelha", "name": "Conch", "price_cents": 5000, "duration_minutes": 45, "description": "Perfuração na região central da cartilagem da orelha.", "image": "/assets/servicos/piercing/conch.jpg", "icon": "◇"},
        {"key": "piercing-rook", "segment": "piercing", "category": "Orelha", "name": "Rook", "price_cents": 5000, "duration_minutes": 45, "description": "Perfuração na dobra interna superior da cartilagem, sujeita à anatomia.", "image": "/assets/servicos/piercing/rook.jpg", "icon": "◇"},
        {"key": "piercing-daith", "segment": "piercing", "category": "Orelha", "name": "Daith", "price_cents": 5000, "duration_minutes": 45, "description": "Perfuração na dobra interna próxima ao canal auditivo, após avaliação anatômica.", "image": "/assets/servicos/piercing/daith.jpg", "icon": "◇"},
        {"key": "piercing-snug", "segment": "piercing", "category": "Orelha", "name": "Snug", "price_cents": 5000, "duration_minutes": 45, "description": "Perfuração horizontal na dobra interna da cartilagem, dependente da anatomia.", "image": "/assets/servicos/piercing/snug.jpg", "icon": "◇"},
        {"key": "piercing-industrial", "segment": "piercing", "category": "Orelha", "name": "Industrial", "price_cents": 9000, "duration_minutes": 60, "description": "Duas perfurações conectadas por uma joia; exige avaliação cuidadosa da anatomia.", "image": "/assets/servicos/piercing/industrial.jpg", "icon": "◇"},
        {"key": "piercing-orbital", "segment": "piercing", "category": "Orelha", "name": "Orbital", "price_cents": 8000, "duration_minutes": 60, "description": "Duas perfurações conectadas pela mesma argola, com planejamento de posição.", "image": "/assets/servicos/piercing/orbital.jpg", "icon": "◇"},
        {"key": "piercing-nostril", "segment": "piercing", "category": "Face", "name": "Nostril", "price_cents": 5000, "duration_minutes": 45, "description": "Perfuração lateral da narina com marcação e joia adequadas à anatomia.", "image": "/assets/servicos/piercing/nostril.jpg", "icon": "✦"},
        {"key": "piercing-septo", "segment": "piercing", "category": "Face", "name": "Septo", "price_cents": 6000, "duration_minutes": 45, "description": "Perfuração do septo em ponto anatômico apropriado, confirmado em avaliação.", "image": "/assets/servicos/piercing/septo.jpg", "icon": "✦"},
        {"key": "piercing-sobrancelha", "segment": "piercing", "category": "Face", "name": "Sobrancelha", "price_cents": 5000, "duration_minutes": 45, "description": "Perfuração na região da sobrancelha, com avaliação de tecido e posicionamento.", "image": "/assets/servicos/piercing/sobrancelha.jpg", "icon": "✦"},
        {"key": "piercing-bridge", "segment": "piercing", "category": "Face", "name": "Bridge", "price_cents": 6000, "duration_minutes": 60, "description": "Perfuração horizontal na ponte nasal, disponível somente após avaliação anatômica.", "image": "/assets/servicos/piercing/bridge.jpg", "icon": "✦"},
        {"key": "piercing-labret", "segment": "piercing", "category": "Face", "name": "Labret ou Vertical Labret", "price_cents": 6000, "duration_minutes": 60, "description": "Perfuração na região do lábio; formato e posição são definidos na avaliação.", "image": "/assets/servicos/piercing/labret.jpg", "icon": "✦"},
        {"key": "piercing-medusa", "segment": "piercing", "category": "Face", "name": "Medusa / Philtrum", "price_cents": 6000, "duration_minutes": 60, "description": "Perfuração central acima do lábio superior, após avaliação profissional.", "image": "/assets/servicos/piercing/medusa.jpg", "icon": "✦"},
        {"key": "piercing-umbigo", "segment": "piercing", "category": "Corpo", "name": "Umbigo", "price_cents": 6000, "duration_minutes": 60, "description": "Perfuração corporal com posicionamento e joia definidos conforme a anatomia.", "image": "/assets/servicos/piercing/umbigo.jpg", "icon": "◆"},
        {"key": "piercing-mamilo", "segment": "piercing", "category": "Corpo", "name": "Mamilo", "price_cents": 7000, "duration_minutes": 60, "description": "Perfuração corporal realizada somente após avaliação, orientação e consentimento.", "image": "/assets/servicos/piercing/mamilo.jpg", "icon": "◆"},
        {"key": "piercing-surface", "segment": "piercing", "category": "Corpo", "name": "Surface", "price_cents": 15000, "duration_minutes": 60, "description": "Perfuração de superfície com análise prévia de tecido, posição e risco de migração.", "image": "/assets/servicos/piercing/surface.jpg", "icon": "◆"},
        {"key": "piercing-microdermal", "segment": "piercing", "category": "Corpo", "name": "Microdermal / Surface Anchor", "price_cents": 18000, "duration_minutes": 60, "description": "Âncora de ponto único, disponível apenas após avaliação técnica e de anatomia.", "image": "/assets/servicos/piercing/microdermal.jpg", "icon": "◆"},
        {"key": "piercing-avaliacao", "segment": "piercing", "category": "Avaliação", "name": "Outras perfurações", "price_cents": 5000, "duration_minutes": 45, "description": "Para projetos personalizados ou outras regiões. A disponibilidade é confirmada antes do procedimento.", "image": "/assets/servicos/piercing/avaliacao.jpg", "icon": "+"},
    ]
)
PUBLIC_REVIEWS = [
    {
...
AVAILABILITY_SEED_VERSION = "2026-08-fixed-daily-slots-v3"
DEFAULT_WEEKLY_SLOTS = ("08:00", "14:00", "19:30")
...
def sync_catalog_services(conn):
    ...
    # A primeira tabela de piercing foi publicada sem preço enquanto os valores
    # eram definidos. Atualiza somente esses registros ainda zerados e preserva
    # qualquer preço personalizado salvo depois no administrativo.
    execute(
        conn,
        """
        UPDATE services
        SET price_cents = CASE catalog_key
            WHEN 'piercing-industrial' THEN 9000
            WHEN 'piercing-orbital' THEN 8000
            WHEN 'piercing-septo' THEN 6000
            WHEN 'piercing-bridge' THEN 6000
            WHEN 'piercing-labret' THEN 6000
            WHEN 'piercing-medusa' THEN 6000
            WHEN 'piercing-umbigo' THEN 6000
            WHEN 'piercing-mamilo' THEN 7000
            WHEN 'piercing-surface' THEN 15000
...
def appointment_payload(appointment_id):
    ...
    if not data:
        return None
    is_piercing = str(data.get("service_key") or "").startswith("piercing-")
    if is_piercing:
        message = (
            "Olá, Letícia! Gostaria de verificar a disponibilidade de uma perfuração.\n\n"
            f"Body Piercing: {data['service_name']}\n"
            f"Valor base: {price_label(data['price_cents'])}\n"
            "Joia básica de aço cirúrgico inclusa.\n"
            "Joias com pedras ou modelos especiais podem alterar o valor.\n\n"
            f"Data desejada: {data['appointment_date']}\n"
